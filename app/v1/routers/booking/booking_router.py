...
@router.get("/vendor-monthly-booking", status_code=status.HTTP_200_OK)
async def user_monthly_booking_count(
    current_user: User = Depends(get_current_user),
    ...
    try:
        result = await booking_manager.vendor_monthly_booking(
