...
class SuperUserManager:
    ...
    async def super_user_list(self, page: int, limit: int, search: str = None, role: str = "admin"):
        try:
    ...
    async def get_super_user(self, id: str):
        try:
    ...
    async def update_super_user(self, id: str, update_super_user_request: SuperUserUpdateRequest):    
        try:
    ...
    async def delete_super_user(self, id: str):   
        try:
